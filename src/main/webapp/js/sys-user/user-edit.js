                ...
                if(res.code == 200){
                    ...
                    $.each(list,function (index,item) {
                        if(roleIds.indexOf(item.id)>-1){
                            html+='<input type="checkbox" checked="true" id="roleId'+ item.id +'" title="'+ item.name +'" name="roleNames" value="'+ item.id +'"/>';
                        } else {
                            html+='<input type="checkbox" id="roleId'+ item.id +'" title="'+ item.name +'" name="roleNames" value="'+ item.id +'"/>';
                        }
                    })
                    $('#roles').append(html);
